        ...
        <div className="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-10 lg:gap-8">
          ...
          <div className="flex flex-col col-span-2 md:col-span-1">
            ...
            <div className="flex space-x-4 mt-4">
              <SocialIcon href="https://www.instagram.com/farmershop001/">
              ...
              <SocialIcon href="https://www.facebook.com/FarmerShop2018">
              ...
              <SocialIcon href="https://www.linkedin.com/company/101026054/admin/dashboard/">
