        ...
        <div className="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-4 lg:gap-8">
          ...
          <div className="flex flex-col col-span-2 md:col-span-1">
            ...
            <div className="flex items-center mb-3">
              <MapPinIcon className="w-6 h-6 mr-3 text-green-400"/>
              <span>India</span>
            </div>
            <div className="flex items-center mb-3">
              <EnvelopeIcon className="min-w-6 h-6 mr-3 text-green-400"/>
              <span>farmershoptechindia@gmail.com</span>
            </div>
            <div className="flex items-center mb-4">
              <PhoneIcon className="w-6 h-6 mr-3 text-green-400"/>
            ...
            <div className="flex space-x-4 mt-4">
              ...
              <SocialIcon href="#">
                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24"><path d="M22 12c0-5.523-4.477-10-10-10S2 6.477 2 12c0 4.991 3.657 9.128 8.438 9.878V14.89h-2.54V12h2.54V9.797c0-2.506 1.492-3.89 3.777-3.89 1.094 0 2.238.195 2.238.195v2.46h-1.26c-1.243 0-1.63.771-1.63 1.562V12h2.773l-.443 2.89h-2.33v7.028C18.343 21.128 22 16.991 22 12z"/></svg>
              </SocialIcon>
              <SocialIcon href="#">
                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 300 300"><path d="M178.57 127.15 290.27 0h-26.46l-99.41 110.93L89.34 0H0l117.13 166.94L0 300.25h26.46l104.05-116.29 81.3 116.29h89.34L178.57 127.15Zm-20.73 22.79L144.44 133.2 38.62 16.16h41.7l102.35 145.49-13.39 19.12-43.23-61.03Z"/></svg>
              </SocialIcon>
              <SocialIcon href="#">
